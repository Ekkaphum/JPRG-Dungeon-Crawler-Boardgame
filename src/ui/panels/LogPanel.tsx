...
export function LogPanel({ log }: { log: ClockLogEvent[] }) {
  ...
  return (
    <div
      ref={scrollRef}
      className="battle-log-board gold-frame rounded-lg p-2 h-full overflow-y-auto overscroll-contain md:absolute md:inset-0 md:min-h-0 text-[11px] font-mono leading-relaxed"
    >
