...
export const en: Record<I18nKey, string> = {
  ...
  'setup.rulesetHint': 'Chosen before the game starts. The experimental one has not been balance-tested.',
  'setup.rulesetExperimentalWarning': '⚠️ Experimental — the 3 new characters are human seats only, bots cannot draft them, and none of the numbers have been through a sim.',
